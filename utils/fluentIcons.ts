...
// nuxt-icon module at work
import { Icon } from "#components";

// We have to defin icons used internally by vuetify components
// I chose the fluent iconset
...
// This object has the component that will render the icons within the application
const fluentSet: IconSet = {
